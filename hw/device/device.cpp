...
static void init_device(data_t data [DIV_ELEMENTS], hls::stream<transmit_t> & in,
...
static void kkt_pipeline_wrapper (data_t & point1, data_t & point2, data_t data [DIV_ELEMENTS],
...
void device(hls::stream<transmit_t> & in, hls::stream<transmit_t> & out) {
    ...
    unsigned int i;
    unsigned int j;
    static data_t data [DIV_ELEMENTS];
